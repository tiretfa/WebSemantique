...
public class BookByAuthor {
    ...
    static final String inputFileName  = "artemisBookstoreData-v2.ttl";

    public static void printBooksByAuthor(final String firstNameInput, final String lastNameInput){
